...
Color primaryColor = Color(0xff81c784);
Color primaryColorLight = Color(0xffb2fab4);
Color primaryColorDark = Color(0xff519657);
Color secondaryColor = Color(0xfff48fb1);
